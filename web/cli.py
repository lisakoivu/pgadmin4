...
parser.add_argument("--schema", help="the name of the schema to diff", dest='schema_name', action='store_true')
...
if response_data['success'] == 1:
  ...
  print("Error end: {}".format(response_data['errormsg']), file=sys.stderr)
